...
% Mandeubsida, since that's the default configuration.
...
\expandafter\ifx\csname haveMandeubsidaSunMoonPS\endcsname\relax\else
...
\Large
만듭시다선문\\
Mandeubsida Sun-Moon

\normalsize

Mandeubsida Sun-Moon has a similar look to Tsukurimashou Bokukko, reminiscent
