...
kanji.  The current count is FIXME, up from 1502 in version 0.8 roughly a
year ago.  But a lot of infrastructure work has been done.  This version was
prepared in a hurry, for reasons to be described below.
...
distribution.  Building from a checkout requires Autotools, as well as
either Subversion or Git to check out the sources in the first place.
...
\begin{verbatim}
# already in tsukurimashou/fontanvil
./configure
make
make install
\end{verbatim}
