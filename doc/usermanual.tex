...
\blsubsection{ＦｏｎｔＦｏｒｇｅだけのメタデータ}{FontForge-specific Metadata (pfed)}
...
family.  At present the fully supported values for the family are
``tsukurimashou'' and ``jieubsida,'' though there is also alpha code for an
italic family called ``tsuita'' and some experimental (less than
