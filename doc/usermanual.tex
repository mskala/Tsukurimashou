...
In the Mandeubsida fonts, this feature breaks precomposed
...
This feature only exists in the Mandeubsida fonts and should be turned on by
...
For instance, in Mandeubsida there is a glyph named ``uni112A'' for code point
