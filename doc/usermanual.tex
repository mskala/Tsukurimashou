...
\begin{description}
  \item{Genjimon} This is a set of standalone fonts for the Genjimon
    symbols, which in the main Tsukurimashou fonts occupy the private-use
    code points U+F17C1 to U+F17F6.  In the standalone fonts, they are
    mapped into the ASCII range for easier access.  GPLv3 with font
    embedding exception.
  \item{IDSgrep} A program for searching databases of tree structures stored
    ...
    structural data extracted from Tsukruimashou.  GPL3.
