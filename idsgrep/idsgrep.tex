...
\section{A note on TrueType/OpenType}\DangerousBend
...
engineers, then interviewing the computational linguists.\footnote{You may
...
filters~\cite{Bloom:Space}.  The bit vector technique used in IDSgrep builds
on Bloom filters and on the work of Skala and
others~\cite{Skala:Generalized} and Skala and Penn~\cite{Skala:Approximate}
on unification of types in logic programming systems.
