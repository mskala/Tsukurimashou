...
int main(int argc, char **argv) {
   ...
   while (fgets(buffer, sizeof(buffer), stdin) != NULL) {
	 ...
	 if (cid == 124)
	    fakeuni = 0x2026;	/* and this is proportional not full */
	 else if (cid >= 425 && cid <= 500)
	    fakeuni = 0x2500 + cid - 425;
	 else if (cid >= 504 && cid <= 505)
	    fakeuni = 0x3014 + cid - 504;
	 else if (cid >= 506 && cid <= 513)
	    fakeuni = 0x3008 + cid - 506;
	    ...
	    fakeuni = 0xd8;
	 else if (cid >= 8720 && cid <= 8814)
	    fakeuni = ' ' + cid - 8720;
	 else if (cid == 9435)
	    fakeuni = 0x237;	/* dotlessj, 0xf6be */
	 else if (cid == 9504)
	    fakeuni = 0xa5;
	 else if (cid >= 9444 && cid <= 9537)
	    fakeuni = ' ' + cid - 9444;
	 else if (cid == 9540)
	    fakeuni = '\\';
	 else if (cid >= 9544 && cid <= 9546)
	    fakeuni = 0xa1 + cid - 9544;
	 else if (cid == 9549)
	    fakeuni = 0xa7;
	 else if (cid == 9550)
	    fakeuni = 0xa4;
	    ...
	    fakeuni = 0xb0;
	 else if (cid >= 9599 && cid <= 9601)
	    fakeuni = 0xb1 + cid - 9599;
	 else if (cid == 9602)
	    fakeuni = 0xb5;
	 else if (cid == 9603)
	    fakeuni = 0xb9;
	 else if (cid >= 9604 && cid <= 9606)
	    fakeuni = 0xbc + cid - 9604;
	 else if (cid >= 9607 && cid <= 9612)
	    fakeuni = 0xc0 + cid - 9607;
	 else if (cid >= 9613 && cid <= 9629)
	    fakeuni = 0xc7 + cid - 9613;
	 else if (cid >= 9630 && cid <= 9641)
	    fakeuni = 0xd9 + cid - 9630;
	 else if (cid >= 9642 && cid <= 9658)
	    fakeuni = 0xe7 + cid - 9642;
	 else if (cid >= 9659 && cid <= 9665)
	    fakeuni = 0xf9 + cid - 9659;
	 else if (cid == 9666)
	    fakeuni = 0x160;
	 else if (cid == 9667)
	    fakeuni = 0x178;
	    ...
	    fakeuni = 0x2070;
	 else if (cid >= 9698 && cid <= 9703)
	    fakeuni = 0x2074 + (cid - 9698);
	 else if (cid >= 9704 && cid <= 9713)
	    fakeuni = 0x2080 + (cid - 9704);
	 else if (cid == 9714)
	    fakeuni = 0x1cd;
	 else if (cid == 9715)
	    fakeuni = 0x11a;
	 ...
	 /* quarter width latin */
	    ...
	    sprintf(buffer, "uni%04X.vert",
		    uni >= VERTMARK ? uni - VERTMARK : uni);
	 else if (fakeuni != -1)
	    sprintf(buffer, "uni%04X.vert",
		    fakeuni >= VERTMARK ? fakeuni - VERTMARK : fakeuni);
	 else
	    continue;
	 /*sprintf( buffer, "japan1-%d.vert", cid ); */
	 nonuni_names[cid] = strdup(buffer);
	 if (uni != -1 && uni < VERTMARK && used[uni])
	    ++used[uni];
	 ...
	 if (uni != -1 && used[uni])
	    ++used[uni];
	 else if (fakeuni != -1 && used[fakeuni])
	    ++used[fakeuni];
   ...
   for (cid = 0; cid <= max; ++cid) {
	 ...
	 for (i = 1;
	      cid + i <= max
	      && cid_2_unicode[cid + i] == cid_2_unicode[cid] + i
	      && cid_2_unicodemult[cid + i][0] == 0; ++i);
	 --i;
	 if (i != 0) {
