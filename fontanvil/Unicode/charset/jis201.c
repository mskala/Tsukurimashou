/* $Id: jis201.c 2918 2014-03-07 16:09:49Z mskala $ */
...
const unichar_t unicode_from_jis201[256] = {
  /*** 0x0000 ***/
...
struct charmap jis201_from_unicode =
   { 0, 255, (unsigned char **) jis201_from_unicode_,
