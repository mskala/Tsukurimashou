/* $Id: acorn2sfd.c 4525 2015-12-20 19:51:59Z mskala $ */
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <ctype.h>
...
static void dohelp(void) {
   printf
      ("acorn2sfd -- reads an acorn RISCOS font and creates an sfd file.\n");
   printf
      (" Acorn RISCOS fonts consist of two files \"Outlines\" and \"Intmetrics\" in a\n");
   printf
      (" directory. This program takes a list of directory names and attempts to\n");
   printf
      (" convert the font data within each directory to one of PfaEdit's sfd files\n\n");
   dousage();
}
