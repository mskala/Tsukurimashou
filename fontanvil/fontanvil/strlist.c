...
struct string_list *prepend_string_list(struct string_list *list,
					const char *str) {
...
struct string_list *append_string_list(struct string_list *list,
				       const char *str) {
   struct string_list *newlist;
...
struct string_list *sort_string_list(struct string_list *list) {
   ...
   qsort(sortarray, cnt, sizeof(struct string_list *),
	 compare_string_list_items);
   for (i = 0; i < cnt - 1; i++) {
